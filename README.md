...
　　🎉 欢迎来到员工考勤管理系统！这是一个基于 Spring Boot 和 Vue.js 的现代化企业级应用，旨在帮助企业高效管理员工考勤数据，提高考勤管理的自动化水平和准确性。无论是小公司还是大集团，我们都能满足你的考勤管理需求哦！ 🎉
...
　　👨‍💼 员工信息的添加、编辑、删除，员工列表展示，员工状态管理（在职/离职），让你轻松管理公司所有人员！

### 2. 📅 考勤管理

　　⏰ 员工打卡（上班/下班），打卡记录查询，考勤状态自动计算（正常/迟到/早退/旷工），再也不用担心考勤统计出错啦！

### 3. 📊 统计报表

　　📈 考勤情况统计图表，员工部门分布图表，详细统计数据表格，支持按月份查询，数据可视化让管理更直观！

### 4. ⚙️ 系统管理

　　🔐 登录/退出功能，系统配置管理，数据缓存管理，保障系统安全稳定运行！

## 🌟 技术特点

1. **前后端分离**：采用 Vue 3 + Spring Boot 的前后端分离架构，提高开发效率和系统可维护性。 🎯

2. **响应式设计**：前端使用 Bootstrap 5 实现响应式布局，适配不同设备屏幕。 📱

3. **数据可视化**：使用 Chart.js 实现数据可视化，直观展示考勤统计数据。 📊

4. **缓存优化**：使用 Redis 进行数据缓存，提高系统性能。 ⚡

5. **限流保护**：集成 Sentinel 进行 API 限流，保护系统安全。 🛡️

6. **配置中心**：使用 Nacos 作为配置中心，方便系统配置管理。 🔧
